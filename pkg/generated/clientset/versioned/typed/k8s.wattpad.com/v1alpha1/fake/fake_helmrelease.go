...
type FakeHelmReleases struct {
	Fake *FakeHelmreleasesV1alpha1
	ns   string
}

var helmreleasesResource = schema.GroupVersionResource{Group: "helmreleases.k8s.wattpad.com", Version: "v1alpha1", Resource: "helmreleases"}

var helmreleasesKind = schema.GroupVersionKind{Group: "helmreleases.k8s.wattpad.com", Version: "v1alpha1", Kind: "HelmRelease"}

// Get takes name of the helmRelease, and returns the corresponding helmRelease object, and an error if there is any.
func (c *FakeHelmReleases) Get(name string, options v1.GetOptions) (result *v1alpha1.HelmRelease, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelmReleases) List(opts v1.ListOptions) (result *v1alpha1.HelmReleaseList, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelmReleases) Create(helmRelease *v1alpha1.HelmRelease) (result *v1alpha1.HelmRelease, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelmReleases) Update(helmRelease *v1alpha1.HelmRelease) (result *v1alpha1.HelmRelease, err error) {
	obj, err := c.Fake.
...
func (c *FakeHelmReleases) UpdateStatus(helmRelease *v1alpha1.HelmRelease) (*v1alpha1.HelmRelease, error) {
	obj, err := c.Fake.
...
func (c *FakeHelmReleases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.HelmRelease, err error) {
	obj, err := c.Fake.
