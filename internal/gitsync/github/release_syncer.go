...
func newReleaseSyncer(c helmClient, namespace, release string, timeout time.Duration) *releaseSyncer {
...
func (r *releaseSyncer) UpdateOrInstallFromChart(ctx context.Context, chart *chart.Chart) error {
