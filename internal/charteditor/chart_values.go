...
func LoadChart(serviceName string, localPath string, client GitClient) (*HelmChart, error) {
	// Grab metadata.yml
	...
	// get values from yaml file in vals path
...
func (c *HelmChart) SetImageTag(tag string, client GitClient) error {
